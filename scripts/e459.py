...
Emacs variables
Local Variables:
compile-command: "cp /home/jack/workspace/python/neuralnilm/scripts/e459.py /mnt/sshfs/imperial/workspace/python/neuralnilm/scripts/"
End:
"""
