...
def exp_a(name):
    ...
    e97
    set max_input_power to 3000 to scale input to be larger.
    use large inits for first two layers again
    """
    source = RealApplianceSource(
        ...
        max_input_power=3000, # scale input to be larger
        ...
        skip_probability=0.7,
        X_processing_func=partial(standardise, how='std=1', mean=0.06, std=0.18)
    )
