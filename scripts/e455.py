...
def exp_f(name):
    global source
    source_dict_copy = deepcopy(source_dict)
    source_dict_copy['target_appliance'] = 'coffee maker'
    source = SameLocation(**source_dict_copy)
    net_dict_copy = deepcopy(net_dict)
    net_dict_copy.update(dict(
        experiment_name=name,
...
def exp_g(name):
    global source
    source_dict_copy = deepcopy(source_dict)
    source_dict_copy['target_appliance'] = 'dish washer'
    source = SameLocation(**source_dict_copy)
    net_dict_copy = deepcopy(net_dict)
    net_dict_copy.update(dict(
        experiment_name=name,
...
def exp_h(name):
    global source
    source_dict_copy = deepcopy(source_dict)
    source_dict_copy['target_appliance'] = 'hair dryer'
    source = SameLocation(**source_dict_copy)
    net_dict_copy = deepcopy(net_dict)
    net_dict_copy.update(dict(
        experiment_name=name,
...
def exp_i(name):
    global source
    source_dict_copy = deepcopy(source_dict)
    source_dict_copy['target_appliance'] = 'kettle'
    source = SameLocation(**source_dict_copy)
    net_dict_copy = deepcopy(net_dict)
    net_dict_copy.update(dict(
        experiment_name=name,
...
def exp_j(name):
    global source
    source_dict_copy = deepcopy(source_dict)
    source_dict_copy['target_appliance'] = 'oven'
    source = SameLocation(**source_dict_copy)
    net_dict_copy = deepcopy(net_dict)
    net_dict_copy.update(dict(
        experiment_name=name,
...
def exp_k(name):
    global source
    source_dict_copy = deepcopy(source_dict)
    source_dict_copy['target_appliance'] = 'toaster'
    source = SameLocation(**source_dict_copy)
    net_dict_copy = deepcopy(net_dict)
    net_dict_copy.update(dict(
        experiment_name=name,
...
def exp_l(name):
    global source
    source_dict_copy = deepcopy(source_dict)
    source_dict_copy['target_appliance'] = 'light'
    source = SameLocation(**source_dict_copy)
    net_dict_copy = deepcopy(net_dict)
    net_dict_copy.update(dict(
        experiment_name=name,
...
Emacs variables
Local Variables:
compile-command: "cp /home/jack/workspace/python/neuralnilm/scripts/e455.py /mnt/sshfs/imperial/workspace/python/neuralnilm/scripts/"
End:
"""
