...
def exp_a(name):
    ...
    source_dict_copy['independently_center_inputs'] = False
...
def exp_b(name):
    ...
    source_dict_copy = deepcopy(source_dict)
    SEQ_LENGTH = 256
    source_dict_copy['seq_length'] = SEQ_LENGTH
    source = RandomSegmentsInMemory(**source_dict_copy)
    net_dict_copy = deepcopy(net_dict)
    net_dict_copy.update(dict(
        experiment_name=name,
...
Emacs variables
Local Variables:
compile-command: "cp /home/jack/workspace/python/neuralnilm/scripts/e452.py /mnt/sshfs/imperial/workspace/python/neuralnilm/scripts/"
End:
"""
