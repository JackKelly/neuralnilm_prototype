...
def exp_a(name):
    # like 134a Uniform(5) init for first layer, standard init for other layers
...
def exp_c(name):
    # like A but with inputs in the range [-1,1] and all inits defaults
    source = RealApplianceSource(
        filename='/data/dk3810/ukdale.h5',
        appliances=[
            ['fridge freezer', 'fridge', 'freezer'], 
