...
def net_dict_ae_rnn(seq_length):
    ...
    return dict(
        ...
        layer_changes={
            100001: {
                'new_layers': [
                    {  # Hack to allow us to pipe input into Conv1D
                        'type': ConcatLayer,
                        'axis': 2,
                        'incomings': ['input']
                    },
                    ...
                    },
                    {
                        'type': DimshuffleLayer,
                        'pattern': (0, 2, 1),  # back to (batch, time, features)
                        'label': 'processed_input'
                    },
                    {
                        'type': ConcatLayer,
                        'axis': 2,
                        'incomings': ['processed_input', 'AE_output']
                    },
                    {
                        'type': BLSTMLayer,
                        'num_units': 128,
...
Emacs variables
Local Variables:
compile-command: "cp /home/jack/workspace/python/neuralnilm/scripts/e572.py /mnt/sshfs/imperial/workspace/python/neuralnilm/scripts/"
End:
"""
