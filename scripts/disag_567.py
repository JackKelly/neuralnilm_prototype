...
def disaggregate(net, architecture, mains, appliance):
    ...
    on_power_threshold = net.source.on_power_thresholds[0] if appliance != 'washing machine' else 150
...
Emacs variables
Local Variables:
compile-command: "cp /home/jack/workspace/python/neuralnilm/scripts/disag_567.py /mnt/sshfs/imperial/workspace/python/neuralnilm/scripts/"
End:
"""
