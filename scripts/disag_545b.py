...
Emacs variables
Local Variables:
compile-command: "cp /home/jack/workspace/python/neuralnilm/scripts/disag_545b.py /mnt/sshfs/imperial/workspace/python/neuralnilm/scripts/"
End:
"""
