...
#    updates_func=momentum,
    ...
    learning_rate=1e-10, # start low to allow batch norm to burn in.
...
Emacs variables
Local Variables:
compile-command: "cp /home/jack/workspace/python/neuralnilm/scripts/e538.py /mnt/sshfs/imperial/workspace/python/neuralnilm/scripts/"
End:
"""
