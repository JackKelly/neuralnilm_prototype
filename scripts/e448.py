...
def exp_a(name):
    ...
    source = RandomSegments(**source_dict_copy)
...
Emacs variables
Local Variables:
compile-command: "cp /home/jack/workspace/python/neuralnilm/scripts/e448.py /mnt/sshfs/imperial/workspace/python/neuralnilm/scripts/"
End:
"""
